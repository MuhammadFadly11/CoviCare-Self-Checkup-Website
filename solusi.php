        ...
        <div class="card text-white bg-info mb-3">
          ...
          <div class="card-body text-left ukuran-20">
            ...
            <form method="post" action="solusi.php" enctype="multipart/form-data" role="form">
                ...
                if ($row['isi_solusi']=="Bukan Covid" || $row['isi_solusi']=="Gejala Ringan" || $row['isi_solusi']=="Gejala Parah" || $row['isi_solusi']=="x-4" || $row['isi_solusi']=="x-5") {
                    ...
                    echo "<p>Hasil dari diagnosa kami adalah : <strong style='color:yellow'>".$row['isi_solusi']."</strong></p>";
                }
