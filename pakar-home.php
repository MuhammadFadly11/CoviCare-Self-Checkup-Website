          ...
          <div class="card">
			  ...
			  <div class="card-body">
				  ...
				  <div class="form-group">
				    <label for="exampleFormControlSelect1">Pilih Diagnosis :</label>
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" name="fakta" class="form-control" id="exampleFormControlInput1" placeholder="contoh : mengalami pusing-pusing">
				  </div>
